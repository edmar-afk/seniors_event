...
import SeniorsTable from "../components/dswd/SeniorsTable";
		...
		<>
			...
			<div
				...
				<div className="flex flex-row justify-between">
					<div>
						<p className="text-2xl font-bold">Seniors Table</p>
						<p className="mb-2 text-sm text-gray-600">Manage all registered seniors in the table below.</p>
					</div>
